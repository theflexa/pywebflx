...
| `verify` | `str` | `None` | Seletor para verificar apos o clique |
| `delay_before` | `float` | `None` | Atraso antes do clique |
| `delay_after` | `float` | config | Atraso apos o clique |
...
| `delay_between_keys` | `float` | `0` | Atraso entre teclas (0 = instantaneo) |
...
Todos os metodos aceitam 3 tipos de seletores:
